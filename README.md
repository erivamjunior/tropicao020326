...
## Erro comum no Amplify: `Cannot find module .../amplify/auth/resource`
Se o build falhar no `ampx pipeline-deploy` com erro de resolução de módulo no `amplify/backend.ts`, use import com extensão explícita:
- `./auth/resource.ts`
- `./data/resource.ts`
